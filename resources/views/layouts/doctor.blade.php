        ...
        <ul class="nav user-menu float-right">
            ...
            <li class="nav-item dropdown has-arrow">
                <a href="#" class="dropdown-toggle user-link nav-link" data-toggle="dropdown">
                    ...
                    <span class="user-name-text">Dr. {{ Auth::user()->name }}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="{{ url('/doctor/my-profile') }}">
                        <i class="fa fa-user-circle-o"></i> My Profile
                    </a>
                    <a class="dropdown-item" href="{{ url('doctor/profile/edit') }}">
            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="{{ request()->routeIs('doctor') ? 'active' : '' }}">
                        <a href="{{ route('doctor') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
                    </li>
                    <li class="{{ request()->routeIs('doctor.patients') ? 'active' : '' }}">
                        <a href="{{ route('doctor.patients') }}"><i class="fa fa-wheelchair"></i> <span>My Patients</span></a>
                    </li>
                    <li class="{{ request()->routeIs('doctor.appointments') ? 'active' : '' }}">
                        <a href="{{ route('doctor.appointments') }}"><i class="fa fa-calendar"></i> <span>My Appointments</span></a>
                    </li>
                    <li class="{{ request()->routeIs('doctor.profile.show') ? 'active' : '' }}">
                        <a href="{{ url('/doctor/my-profile') }}"><i class="fa fa-cog"></i> <span>Profile Settings</span></a>
                    </li>
                </ul>
            </div>
        </div>
